...
public class GerenteGUI extends javax.swing.JFrame {
    ...
    private void jButtomFuncMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtomFuncMouseClicked
        FuncionarioGUI janfun = new FuncionarioGUI();
        janfun.setLocationRelativeTo(null);
        janfun.setVisible(true);
        janfun.setResizable(false);
        this.dispose();
    ...
    private void jButtomCaixaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtomCaixaMouseClicked
        GerenteVendaGUI janVenda = new GerenteVendaGUI();
    ...
    private void jButtomEstatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtomEstatMouseClicked
        EstatisticasFinanceiras janEstat = new EstatisticasFinanceiras();
        janEstat.setLocationRelativeTo(null);
        janEstat.setVisible(true);
        janEstat.setResizable(false);
        this.dispose();
    ...
    private void jButtomSaboresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtomSaboresMouseClicked
        ControleDeSabores janSab = new ControleDeSabores();
        janSab.setLocationRelativeTo(null);
        janSab.setVisible(true);
        janSab.setResizable(false);
        this.dispose();
    ...
    private void jButtomVendasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtomVendasMouseClicked
        ControleDeVendas janVen = new ControleDeVendas();
        janVen.setLocationRelativeTo(null);
        janVen.setVisible(true);
        janVen.setResizable(false);
        this.dispose();
