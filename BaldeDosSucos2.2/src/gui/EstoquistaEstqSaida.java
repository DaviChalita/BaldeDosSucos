 ...
 * @author Cliente
 */
public class EstoquistaEstqSaida extends javax.swing.JFrame {

    /**
     * Creates new form EstqSaida
     */
    public EstoquistaEstqSaida() {
        initComponents();
        setIcon();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EstoquistaEstqSaida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EstoquistaEstqSaida().setVisible(true);
            }
        });
    }
