...
<h3>Adquira agora mesmo o seu cartão fidelidade</h3>
<?php 
...
?>
<center><b>Para obter seu cartão fidelidade, é necessário realizar o login no site.</b></p>
É novo por aqui?<p>
...
<br />
<br />
<center><img src='fidelidadeimagem.php' style="border: 2px dashed #000; padding: 5px 5px 5px 5px;" /></br>
<font style="font-size:18px; font-family: 'caviar_dreamsregular'; font-weight: bold;">Recorte a linha tracejada</font><p>
<form>
  <input type='submit' value='Imprimir' OnClick='javascript:DoPrinting()'>
</form></center>
<?php
	 }
   ?>
