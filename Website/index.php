...
<div id="wowslider-container0">
	<div class="ws_images"><ul>
		...
		<li><a href="./sabores.php"><img src="./Galeria/laranja_full.png" alt="Foto promocional de laranja" title="Foto promocional de laranja" id="wows0_0"/></a></li>
		<li><a href="./sabores.php"><img src="./Galeria/limo_full.png" alt="Foto promocional de limão" title="Foto promocional de limão" id="wows0_1"/></a></li>
		<li><a href="./sabores.php"><img src="./Galeria/melancia_full.png" alt="Foto promocional de melancia" title="Foto promocional de melancia" id="wows0_2"/></a></li>
		<li><a href="./sabores.php"><img src="./Galeria/uva_full.png" alt="Foto promocional de uva" title="Foto promocional de uva" id="wows0_3"/></a></li>
